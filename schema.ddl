...
/*
** Each row contains the information of a unique game.
** Information includes: game title, genre, release date, developer.
** Every game is assigned to a unique game id.
*/
CREATE TABLE  Game(
...
/*
** In each row, the game (game_id) is developed by the developer.
*/
...
/*
** In each row, the game (game_id) can be run on that platform.
*/
...
/*
** In each row, the game (game_id) has "positive_ratings" number of
** positive ratings, and "negative_ratings" number of
** negative ratings.
*/
CREATE TABLE Rating(
...
/*
** Each row contains the average playtime and median playtime of the game.
*/
...
/*
** Each row contains all the languages that the game can support.
*/
...
/*
** Each row contains the price and the history-lowest discount price of the game.
*/
CREATE TABLE Price(
	game_id INTEGER PRIMARY KEY REFERENCES Game(game_id),
	price FLOAT,
